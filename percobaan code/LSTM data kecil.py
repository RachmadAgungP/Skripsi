...
class LSTMCell: 
    ...
    def backwardStep(self, t, dE_dh_t, dE_dc_tplus1):
        ...
        # print("dE_do_t SESUDAH[%s]"%t,dE_do_t)
    ...
    def BPTT(self, y):
        ...
        for i in range(numTimePeriods):
            ...
            # dikarenakn BPTT hanya menerima 1 atau -1 makan harus diproses.
...
def main():
    ...
    data = readData('Data_implementasi Close.csv')
    corpusData = data[0]
    ...
    for sequence in forecastSequences: 
        countForecasts += 1
        print("forecast [%s]======================================================"%countForecasts)
